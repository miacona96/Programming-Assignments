...
{	int j, h = now._nr_pr;
	...
	{	int l_in;
		...
		{
			((P1 *)pptr(h))->_2_Flag[l_in] = 1;
		}
	}
		((P1 *)pptr(h))->_2_a = addqueue(1, 0);
		((P1 *)pptr(h))->_2_b = addqueue(2, 0);
		((P1 *)pptr(h))->_2_c = addqueue(3, 0);
		((P1 *)pptr(h))->_2_d = addqueue(4, 0);
		((P1 *)pptr(h))->_2_e = addqueue(5, 0);
#ifdef VAR_RANGES
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval(":init::_2_Flag[l_in]", ((P1 *)pptr(h))->_2_Flag[l_in]);
		}
	}
#endif
#ifdef HAS_CODE
	...
	case 0:	/* Node */
		...
		reached0[1]=1;
		/* params: */
		((P0 *)pptr(h))->channel_in = par0;
		((P0 *)pptr(h))->channel_out = par1;
		/* locals: */
		((P0 *)pptr(h))->_1_token = 0;
#ifdef VAR_RANGES
		logval("Node:token", ((P0 *)pptr(h))->_1_token);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->channel_in) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->channel_in) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->channel_in) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->channel_in) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->channel_out) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->channel_out) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->channel_out) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->channel_out) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_2_a) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_2_a) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_2_a) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_2_a) )))
			    ) return 0; break;
		case 4: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_2_b) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_2_b) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_2_b) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_2_b) )))
			    ) return 0; break;
		case 5: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_2_c) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_2_c) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_2_c) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_2_c) )))
			    ) return 0; break;
		case 6: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_2_d) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_2_d) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_2_d) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_2_d) )))
			    ) return 0; break;
		case 7: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_2_e) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_2_e) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_2_e) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_2_e) )))
			    ) return 0; break;
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	bit    Flag[%d]:	%d\n", l_in, ((P1 *)pptr(pid))->_2_Flag[l_in]);
		}
	}
	printf("	chan a (=%d):	len %d:\t", ((P1 *)pptr(pid))->_2_a, q_len(((P1 *)pptr(pid))->_2_a));
	c_chandump(((P1 *)pptr(pid))->_2_a);
	printf("	chan b (=%d):	len %d:\t", ((P1 *)pptr(pid))->_2_b, q_len(((P1 *)pptr(pid))->_2_b));
	c_chandump(((P1 *)pptr(pid))->_2_b);
	printf("	chan c (=%d):	len %d:\t", ((P1 *)pptr(pid))->_2_c, q_len(((P1 *)pptr(pid))->_2_c));
	c_chandump(((P1 *)pptr(pid))->_2_c);
	printf("	chan d (=%d):	len %d:\t", ((P1 *)pptr(pid))->_2_d, q_len(((P1 *)pptr(pid))->_2_d));
	c_chandump(((P1 *)pptr(pid))->_2_d);
	printf("	chan e (=%d):	len %d:\t", ((P1 *)pptr(pid))->_2_e, q_len(((P1 *)pptr(pid))->_2_e));
	c_chandump(((P1 *)pptr(pid))->_2_e);
		break;
	case 0:
		printf("local vars proc %d (Node):\n", pid);
	printf("	chan channel_in (=%d):	len %d:\t", ((P0 *)pptr(pid))->channel_in, q_len(((P0 *)pptr(pid))->channel_in));
	c_chandump(((P0 *)pptr(pid))->channel_in);
	printf("	chan channel_out (=%d):	len %d:\t", ((P0 *)pptr(pid))->channel_out, q_len(((P0 *)pptr(pid))->channel_out));
	c_chandump(((P0 *)pptr(pid))->channel_out);
	printf("	byte   token:	%d\n", ((P0 *)pptr(pid))->_1_token);
		break;
	}
}
void
