...
console.log(lab1.questionOne([0, 2, 0])); // 4
console.log(lab1.questionOne([5, 4, 3])); // 50
...
// should output 196
console.log(lab1.questionThree("My nama Jeff")); // 3
console.log(lab1.questionThree("bcdfghy xxx xrt")); // 0
